<article class="card">
  ...
  <?php if ($embed): ?>
    ...
    <div class="video-wrap">
      <iframe src="<?= e($embed) ?>" title="Service tutorial" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen loading="lazy"></iframe>
    </div>
